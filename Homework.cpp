...
int main(){
 ...
 printf("\nVui long nhap lai So Dien\nSo dien khong duoc nho hon 0\n");
  ...
  printf("\nban da dung dien trong khoang 0 - 100 kW so tien ban phai tra la:",tienDien);
 }else if(soDien<=150){
  tienDien=100*bac1+((soDien-100)*bac2);
  printf("\nban da dung dien trong khoang 101 - 150 kW so tien ban phai tra la:",tienDien);
 }else if(soDien<=200){
  tienDien=100*bac1+(50*bac2)+((soDien-150)*bac3);
  printf("\nban da dung dien trong khoang 151 - 200 kWh so tien ban phai tra la:",tienDien);
 }else if(soDien<=300){
